# Lint as: python3
""" HuggingFace/Data-Measurements is an open library for measuring datasets.
...
setup(
    ...
    description="HuggingFace community-driven open-source library for dataset measurement",
    long_description=open("README.md", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    author="HuggingFace Inc.",
    author_email="nima@huggingface.co",
    url="https://github.com/HuggingFace/data-measurements",
    download_url="https://github.com/HuggingFace/data-measurements/tags",
    license="Apache 2.0",
    package_dir={"": "src"},
    ...
    keywords="machine learning dataset measurement",
